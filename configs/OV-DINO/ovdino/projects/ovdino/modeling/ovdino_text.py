...
class OVDINO_Text(nn.Module):
    ...
    def __init__(
        ...
        self.tunable_linear = torch.nn.Linear(text_embed_dim, 1000, bias=False)
    ...
    def forward(self, batched_inputs):
        ...
        text_embed = self.tunable_linear.weight[:text_embed.size(1), :].unsqueeze(0) + text_embed
