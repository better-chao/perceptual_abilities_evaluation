...
from projects.ovdino.modeling.ovdino_text import OVDINO_Text
...
model = L(OVDINO_Text)(
    ...
    language_backbone=L(BERTEncoder)(
        tokenizer_cfg=dict(tokenizer_name="your_path/bert-no-uncased"),
        model_name="your_path/bert-no-uncased",
        output_dim=256,
