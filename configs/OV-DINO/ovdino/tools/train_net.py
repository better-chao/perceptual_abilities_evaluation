...
import detrex
from detrex.data.datasets.register_custom_ovdv2 import CUSTOM_CATEGORIES, NUM_CATEGORY, _PREDEFINED_SPLITS
import json

# Modify for your dataset path
...
_PREDEFINED_SPLITS["custom_train_ovd_unipro"] = (
        train_data_prefix,
        train_ann_file,
        NUM_CATEGORY,
        "full",
    )
_PREDEFINED_SPLITS["custom_val_ovd_unipro"] = (
        val_data_prefix,
        val_ann_file,
        NUM_CATEGORY,
        "identity",
    )
_PREDEFINED_SPLITS["custom_test_ovd"] = (
        val_data_prefix,
        val_data_prefix,
        NUM_CATEGORY,
        "identity",
...
from detrex.data.datasets import register_custom_ovdv2

register_custom_ovdv2.update(NUM_CATEGORY)
print(detrex.data.datasets.register_custom_ovdv2.CUSTOM_CATEGORIES)
print(detrex.data.datasets.register_custom_ovdv2.NUM_CATEGORY)
register_custom_ovdv2.register_all_custom_instances(data_root)
...
def main(args):
    ...
    if args.eval_only:
        ...
        cfg.model.num_classes = NUM_CATEGORY
        cfg.model.test_num_classes = NUM_CATEGORY
        do_train(args, cfg)
