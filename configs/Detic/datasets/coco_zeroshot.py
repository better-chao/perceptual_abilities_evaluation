...
_PREDEFINED_SPLITS_COCO = {
    ...
    "coco_zeroshot_val": ("coco/val2017", "coco/annotations/instances_val2017.json", 'all'),
    ...
    "coco_generalized_zeroshot_val": ("coco/val2017", "coco/annotations/instances_val2017.json", 'all'),
    "coco_zeroshot_train_oriorder": ("coco/train2017", "coco/annotations/instances_train2017.json", 'all'),
}
