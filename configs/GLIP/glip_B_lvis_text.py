_base_ = 'mmdet::glip/glip_atss_swin-t_b_fpn_dyhead_16xb2_ms-2x_funtune_coco.py'
...
model = dict(
    ...
    bbox_head=dict(
        type='ATSSVLFusionHead_PromptTuning',
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            'bbox_head.head.tunable_linear':dict(lr_mult=1.),
        }),
    clip_grad=None)

work_dir = 'work_dirs/glip_crowdhuman_prompt_tuning'